...
VO::VO(std::string dataset, Map &map) : my_map_(map)
{
    dataset_ = dataset;
    detector_ = cv::ORB::create(3000);
    descriptor_ = cv::ORB::create();
...
bool VO::insert_key_frame(bool check, std::vector<cv::Point3f> &pts_3d, std::vector<cv::KeyPoint> &keypoints, cv::Mat &descriptors)
{
    ...
    cout << "[TIME] add_observations function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    ...
    cout << "[TIME] disparity_map function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    start = high_resolution_clock::now();
    ...
    cout << "[TIME] add_features function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    start = high_resolution_clock::now();
    ...
    cout << "[TIME] final insert_keyframe function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    start = high_resolution_clock::now();
...
bool VO::tracking(bool &if_insert_keyframe)
{
    ...
    cout << "[TIME] read_img function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    start = high_resolution_clock::now();
    ...
    cout << "[TIME] feature_detection function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    start = high_resolution_clock::now();
    ...
    cout << "[TIME] feature_matching function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    start = high_resolution_clock::now();
    ...
    cout << "[TIME] feature_to_add function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    start = high_resolution_clock::now();
    ...
    cout << "[TIME] motion_estimation function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    start = high_resolution_clock::now();
    ...
    cout << "[TIME] check_motion_estimation function: " << duration_cast<milliseconds>(high_resolution_clock::now() - start).count() << " ms" << endl;
    start = high_resolution_clock::now();
